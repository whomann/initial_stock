...
## Концепт
Изначально вводится бесконечное количество начальных остатков. Через некоторое время работник склада проводит по введенным документам ревизию, вводя текущий остаток товаров. Таким образом документы начальных остатков после ревизии отразят настоящие остатки: отгруженное количество товара с даты документа + потраченное количество товара с даты документа + введенный во время ревизии остаток. Полезно на проектах внедрения.
